...
G.load_state_dict(torch.load('/media/data_cifs/projects/prj_categorization/results/CIFAR_cDCGAN/netG_epoch_24.pth')) #path to generator output specified to epoch that it is loading
